...
4. The archive is mean to be maintained tidy. Yet if any supplementary non-standard data should be stored, put them under a folder whose name starting with `_` prefix. (eg. `_Faults_no_computed`)
